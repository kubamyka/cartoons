...
fun CartoonDetailsTexts(
    ...
    Column(modifier = modifier.padding(16.dp)) {
        ...
        if (cartoon.creators.isNotEmpty()) {
            LabelledTextForListOfStrings(
                singleResource = R.string.creator,
                pluralResource = R.string.creators,
                list = cartoon.creators,
            )
        }
        if (cartoon.genres.isNotEmpty()) {
            LabelledTextForListOfStrings(
                singleResource = R.string.genre,
                pluralResource = R.string.genres,
                list = cartoon.genres,
            )
        }
    }
...
@Composable
private fun LabelledTextForListOfStrings(
    @StringRes
    singleResource: Int,
    @StringRes
    pluralResource: Int,
    ...
    LabelledText(
        label = if (list.size == 1) singleResource else pluralResource,
